...
public class stage3_uncorrect extends JFrame{
	
	public stage3_uncorrect() {
		...
		ImageIcon p = resizeImg("img/ham/spot.png", 150, 150);
		JLabel spot = new JLabel(p);
		spot.setBounds(hamster.getX() + 250, res.height- 220, 150, 150);
		...
		ImageIcon u = resizeImg("img/ham/stage3_uncorrect.png", 450, 195);
		JLabel talk = new JLabel(u);
		talk.setBounds(res.width - 500, res.height /5- 150, 450, 300);
		...
		TimerTask task = new TimerTask() {			
			@Override
			public void run() {
				InfoDialog info = new InfoDialog(4,"<html>오답!<br><br>" + "햄스터의 병은 기생충성 장염이다.<br><br>"
